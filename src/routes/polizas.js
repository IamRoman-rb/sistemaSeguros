...
import { listado, nueva, detalle, confirmar, editar, guardar, actualizar, eliminar,renovar, propuesta, riesgos} from "../controllers/polizasController.js";
...
router.get('/riesgos', hasPermitions, riesgos);
